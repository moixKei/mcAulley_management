...
public class CursoController {
    ...
    // ✅ Listar todos los cursos - CORREGIDO
    @GetMapping
    public String listarCursos(Model model) {
        model.addAttribute("cursos", cursoService.listarTodos());
        model.addAttribute("totalCursos", cursoService.listarTodos().size());
        model.addAttribute("cursosActivosCount", cursoService.contarCursosActivos());
        return "cursos/lista";
    }

    // ✅ Buscar cursos por nombre - CORREGIDO
    @GetMapping("/buscar")
    ...
    public String mostrarFormularioNuevo(Model model) {
        ...
        // Establecer un estado por defecto si es necesario
        // estadoCursoService.buscarEstadoActivo() o similar
